...
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"})")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"</"),s("span",{style:{color:"#22863A"}},"script"),s("span",{style:{color:"#24292E"}},">")])])])],-1),k=JSON.parse('{"title":"useTable","description":"","frontmatter":{},"headers":[],"relativePath":"hooks/useTable.md","filePath":"hooks/useTable.md","lastUpdated":null}'),A={name:"hooks/useTable.md"},q=Object.assign(A,{setup(i){return(e,a)=>{const n=E("demo");return y(),b("div",null,[B,x,v,p(n,{customClass:"demoblock-custom",sourceCode:`<template>
...
<\/script>
`},{highlight:r(()=>[g]),default:r(()=>[p(h)]),_:1})])}}});export{k as __pageData,q as default};
