...
`),s("span",{class:"line"},[s("span",{style:{color:"#F97583"}},"import"),s("span",{style:{color:"#E1E4E8"}}," "),s("span",{style:{color:"#F97583"}},"type"),s("span",{style:{color:"#E1E4E8"}}," { EditTableCellParams, EditTableCellendeditParams } "),s("span",{style:{color:"#F97583"}},"from"),s("span",{style:{color:"#E1E4E8"}}," "),s("span",{style:{color:"#9ECBFF"}},"'@devops-web/components'")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#D73A49"}},"import"),s("span",{style:{color:"#24292E"}}," "),s("span",{style:{color:"#D73A49"}},"type"),s("span",{style:{color:"#24292E"}}," { EditTableCellParams, EditTableCellendeditParams } "),s("span",{style:{color:"#D73A49"}},"from"),s("span",{style:{color:"#24292E"}}," "),s("span",{style:{color:"#032F62"}},"'@devops-web/components'")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"  }")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"}")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"</"),s("span",{style:{color:"#22863A"}},"script"),s("span",{style:{color:"#24292E"}},">")])])])],-1),j=JSON.parse('{"title":"edit-table","description":"","frontmatter":{},"headers":[],"relativePath":"components/edit-table.md","filePath":"components/edit-table.md","lastUpdated":1703751966000}'),S={name:"components/edit-table.md"},H=Object.assign(S,{setup(B){return(u,b)=>{const y=t("demo");return E(),T("div",null,[k,z,c(y,{customClass:"demoblock-custom",sourceCode:`<template>
