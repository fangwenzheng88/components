import{u as B}from"./chunks/index.f6cd8c68.js";import"./chunks/use-popup-manager.76a89a53.js";import{M as h}from"./chunks/index.7e32a237.js";import{d as f,h as A,C as c,o as v,c as b,H as n,l as y,k as s,w as t,a as l,F as D,a4 as k,j as w}from"./chunks/framework.aaf613a4.js";import"./chunks/is.816509ab.js";const V={style:{"margin-top":"20px"}},O=f({__name:"useSelectOptions.md.demo.128e6f3e",setup(g){const e=A(),{options:r,getLabels:p}=B([{label:"label-1",value:"1"},{label:"label-2",value:"2"},{label:"label-3",value:"3"}]);function u(){const i=p(e.value);h.info(String(i))}return(i,F)=>{const a=c("a-select"),o=c("a-button"),E=c("a-space");return v(),b(D,null,[n(a,{modelValue:e.value,"onUpdate:modelValue":F[0]||(F[0]=d=>e.value=d),class:"vp-raw",style:{width:"320px"},placeholder:"Please select ...",options:y(r)},null,8,["modelValue","options"]),s("div",V,[n(E,null,{default:t(()=>[n(o,{type:"primary",onClick:u},{default:t(()=>[l("getLabels")]),_:1})]),_:1})])],64)}}}),S={style:{"margin-top":"20px"}},L=f({__name:"useSelectOptions.md.demo.128e6f3c",setup(g){const e=A(),{options:r,getLabels:p,loading:u,loadOptions:i}=B(a=>a?new Promise(o=>{setTimeout(()=>{o([{label:`label-${a}`,value:a}])},2e3)}):Promise.resolve([]));function F(){const a=p(e.value);h.info(String(a))}return(a,o)=>{const E=c("a-select"),d=c("a-button"),C=c("a-space");return v(),b(D,null,[n(E,{modelValue:e.value,"onUpdate:modelValue":o[0]||(o[0]=m=>e.value=m),class:"vp-raw",style:{width:"320px"},placeholder:"Please select ...",options:y(r),loading:y(u),"allow-search":!0,onSearch:y(i)},null,8,["modelValue","options","loading","onSearch"]),s("div",S,[n(C,null,{default:t(()=>[n(d,{type:"primary",onClick:F},{default:t(()=>[l("getLabels")]),_:1})]),_:1})])],64)}}}),x={style:{"margin-top":"20px"}},P=f({__name:"useSelectOptions.md.demo.128e6f3a",setup(g){const e=A([]),{options:r,getLabels:p,loading:u,loadOptions:i}=B(a=>a?new Promise(o=>{setTimeout(()=>{o([{label:`label-${a}`,value:a}])},2e3)}):Promise.resolve([]));function F(){const a=p(e.value);h.info(String(a))}return(a,o)=>{const E=c("a-select"),d=c("a-button"),C=c("a-space");return v(),b(D,null,[n(E,{modelValue:e.value,"onUpdate:modelValue":o[0]||(o[0]=m=>e.value=m),class:"vp-raw",style:{width:"320px"},placeholder:"Please select ...",options:y(r),loading:y(u),"allow-search":!0,multiple:"","show-extra-options":!1,onSearch:y(i)},null,8,["modelValue","options","loading","onSearch"]),s("div",x,[n(C,null,{default:t(()=>[n(d,{type:"primary",onClick:F},{default:t(()=>[l("getLabels")]),_:1})]),_:1})])],64)}}}),M={style:{"margin-top":"20px"}},$=f({__name:"useSelectOptions.md.demo.128e6f38",setup(g){const e=k({selectValue:"",selectLabel:""}),r=A(),{options:p,getLabels:u,loading:i,loadOptions:F}=B(o=>o?new Promise(E=>{setTimeout(()=>{E([{label:`label-${o}`,value:o}])},2e3)}):Promise.resolve([]),{fallback(o){return o===e.selectValue?{label:e.selectLabel,value:e.selectValue}:{value:o,label:void 0}}});w(()=>{setTimeout(()=>{Object.assign(e,{selectValue:"999",selectLabel:"label-999"}),r.value=e.selectValue},1e3)});function a(){const o=u(r.value);h.info(String(o))}return(o,E)=>{const d=c("a-select"),C=c("a-button"),m=c("a-space");return v(),b(D,null,[n(d,{modelValue:r.value,"onUpdate:modelValue":E[0]||(E[0]=_=>r.value=_),class:"vp-raw",style:{width:"320px"},placeholder:"Please select ...",options:y(p),loading:y(i),"allow-search":!0,multiple:"",onSearch:y(F)},null,8,["modelValue","options","loading","onSearch"]),s("div",M,[n(m,null,{default:t(()=>[n(C,{type:"primary",onClick:a},{default:t(()=>[l("getLabels")]),_:1})]),_:1})])],64)}}}),T=s("h1",{id:"useselectoptions",tabindex:"-1"},[l("useSelectOptions "),s("a",{class:"header-anchor",href:"#useselectoptions","aria-label":'Permalink to "useSelectOptions"'},"​")],-1),j=s("p",null,[l("简化 "),s("code",null,"a-select"),l(" options 的定义，并在远程搜索的时候缓存历史 options，避免多选场景下远程搜素时无法展示 label 的情况")],-1),U=s("h2",{id:"简单示例",tabindex:"-1"},[l("简单示例 "),s("a",{class:"header-anchor",href:"#简单示例","aria-label":'Permalink to "简单示例"'},"​")],-1),N=s("div",{class:"language-vue vp-adaptive-theme"},[s("span",{class:"lang"},"vue"),s("pre",{"v-pre":"",class:"shiki github-dark vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"<"),s("span",{style:{color:"#85E89D"}},"template"),s("span",{style:{color:"#E1E4E8"}},">")]),l(`
...
<\/script>
`,options:'{"customClass":"demoblock-custom"}'},{highlight:t(()=>[N]),default:t(()=>[n(O)]),_:1}),H,n(p,{customClass:"demoblock-custom",sourceCode:`<template>
  <a-select
    v-model="value"
    class="vp-raw"
    style="width: 320px"
...
<\/script>
`,options:'{"customClass":"demoblock-custom"}'},{highlight:t(()=>[J]),default:t(()=>[n(L)]),_:1}),q,n(p,{customClass:"demoblock-custom",sourceCode:`<template>
  <a-select
    v-model="value"
    class="vp-raw"
    style="width: 320px"
...
<\/script>
`,options:'{"customClass":"demoblock-custom"}'},{highlight:t(()=>[z]),default:t(()=>[n(P)]),_:1}),G,n(p,{customClass:"demoblock-custom",sourceCode:`<template>
  <a-select
    v-model="value"
    class="vp-raw"
    style="width: 320px"
...
<\/script>
`,options:'{"customClass":"demoblock-custom"}'},{highlight:t(()=>[I]),default:t(()=>[n($)]),_:1})])}}});export{Z as __pageData,ss as default};
