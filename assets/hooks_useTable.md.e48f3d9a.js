import"./chunks/dayjs.min.1edc150c.js";import{i as C}from"./chunks/is.51048137.js";import{u as h}from"./chunks/index.36dec720.js";import{h as E,a3 as b,d as B,C as F,o as m,b as g,L as x,l as v,c as f,H as i,w as d,k as s,a as l}from"./chunks/framework.09a0dcac.js";const u=()=>({current:1,pageSize:10,total:0,showTotal:!0,showPageSize:!0});function D(e){const a=E(!1),t=E(),n=h(e.columns),o=E(!1);let r,c;(e.pagination===!0||C(e.pagination))&&(o.value=e.pagination===!0?u():{...u(),...e.pagination},r=p=>{o.value.current=p},c=p=>{o.value.current=1,o.value.pageSize=p});function y(){return a.value=!0,e.fetch().then(p=>{t.value=p,e.pagination!==!1&&(o.value.total=p.length)}).finally(()=>{a.value=!1})}return e.immediate===!0&&y(),{tableData:t,loading:a,loadTableData:y,pagination:o,tableInstance:n.tableInstance,originColumns:n.originColumns,columns:n.columns,resetColumns:n.resetColumns,changeColumnVisibleByPath:n.changeColumnVisibleByPath,changeColumnVisibleByDataIndex:n.changeColumnVisibleByDataIndex,updateColumnByPath:n.updateColumnByPath,updateColumnByDataIndex:n.updateColumnByDataIndex,replaceColumnByPath:n.replaceColumnByPath,replaceColumnByDataIndex:n.replaceColumnByDataIndex,tableConfig:b({loading:a,data:t,columns:n.columns,ref:n.ref,pagination:o,onPageChange:r,onPageSizeChange:c})}}const w=B({__name:"useTable.md.demo.4cb3a1a6",setup(e){function a(){return new Promise(n=>{const o=new Array(30).fill(1).map((r,c)=>({index:c+1,name:`name-${c}`,htbhnew:`NO-${c}`,qdrq:new Date,level:1}));setTimeout(()=>{n(o)})})}const{tableConfig:t}=D({fetch:a,columns:[{title:"编号",dataIndex:"index",width:120},{title:"事项主题",dataIndex:"name"},{title:"相关合同",dataIndex:"htbhnew"},{title:"到期日期",dataIndex:"qdrq"},{title:"优先级",dataIndex:"level"}],immediate:!0,pagination:!0});return(n,o)=>{const r=F("a-table");return m(),g(r,x({class:"vp-raw"},v(t)),null,16)}}}),A=s("h1",{id:"usetable",tabindex:"-1"},[l("useTable "),s("a",{class:"header-anchor",href:"#usetable","aria-label":'Permalink to "useTable"'},"​")],-1),_=s("p",null,[s("code",null,"a-table"),l(" 前端分页、不分页场景的工具函数，简化前端表格的配置")],-1),I=s("p",null,[l("通过 "),s("code",null,"useColumns"),l(" 实现表格列minWidth，visible的功能")],-1),T=s("div",{class:"language-vue vp-adaptive-theme"},[s("span",{class:"lang"},"vue"),s("pre",{"v-pre":"",class:"shiki github-dark vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"<"),s("span",{style:{color:"#85E89D"}},"template"),s("span",{style:{color:"#E1E4E8"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"})")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"</"),s("span",{style:{color:"#22863A"}},"script"),s("span",{style:{color:"#24292E"}},">")])])])],-1),N=JSON.parse('{"title":"useTable","description":"","frontmatter":{},"headers":[],"relativePath":"hooks/useTable.md","filePath":"hooks/useTable.md","lastUpdated":null}'),P={name:"hooks/useTable.md"},O=Object.assign(P,{setup(e){return(a,t)=>{const n=F("demo");return m(),f("div",null,[A,_,I,i(n,{customClass:"demoblock-custom",sourceCode:`<template>
...
<\/script>
`},{highlight:d(()=>[T]),default:d(()=>[i(w)]),_:1})])}}});export{N as __pageData,O as default};
