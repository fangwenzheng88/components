...
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"})")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"</"),s("span",{style:{color:"#22863A"}},"script"),s("span",{style:{color:"#24292E"}},">")])])])],-1),L=JSON.parse('{"title":"columns-setting","description":"","frontmatter":{},"headers":[],"relativePath":"components/columns-setting.md","filePath":"components/columns-setting.md","lastUpdated":1715764023000}'),w={name:"components/columns-setting.md"},N=Object.assign(w,{setup(m){return(c,p)=>{const n=t("demo");return d(),F("div",null,[A,_,D,a(n,{customClass:"demoblock-custom",sourceCode:`<template>
