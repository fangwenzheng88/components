import"./chunks/dayjs.min.1edc150c.js";import{u as F}from"./chunks/useTable.64b8ce77.js";import{d,C as E,o as y,b as m,L as C,l as u,c as B,H as p,w as r,k as s,a as l}from"./chunks/framework.b77cafc3.js";import"./chunks/is.51048137.js";import"./chunks/index.4219e003.js";const h=d({__name:"demo1.md.demo.27005edc",setup(i){function e(){return new Promise(n=>{const t=new Array(30).fill(1).map((c,o)=>({index:o+1,name:`name-${o}`,htbhnew:`NO-${o}`,qdrq:new Date,level:1}));setTimeout(()=>{n(t)})})}const{tableConfig:a}=F({fetch:e,columns:[{title:"编号",dataIndex:"index",width:120},{title:"事项主题",dataIndex:"name"},{title:"相关合同",dataIndex:"htbhnew"},{title:"到期日期",dataIndex:"qdrq"},{title:"优先级",dataIndex:"level"}],immediate:!0,pagination:!0});return(n,t)=>{const c=E("a-table");return y(),m(c,C({class:"vp-raw"},u(a)),null,16)}}}),b=s("h1",{id:"usetable",tabindex:"-1"},[l("useTable "),s("a",{class:"header-anchor",href:"#usetable","aria-label":'Permalink to "useTable"'},"​")],-1),x=s("div",{class:"language-vue vp-adaptive-theme"},[s("span",{class:"lang"},"vue"),s("pre",{"v-pre":"",class:"shiki github-dark vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"<"),s("span",{style:{color:"#85E89D"}},"template"),s("span",{style:{color:"#E1E4E8"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"})")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"</"),s("span",{style:{color:"#22863A"}},"script"),s("span",{style:{color:"#24292E"}},">")])])])],-1),_=JSON.parse('{"title":"useTable","description":"","frontmatter":{},"headers":[],"relativePath":"components/demo1.md","filePath":"components/demo1.md","lastUpdated":1699244817000}'),g={name:"components/demo1.md"},I=Object.assign(g,{setup(i){return(e,a)=>{const n=E("demo");return y(),B("div",null,[b,p(n,{customClass:"demoblock-custom",sourceCode:`<template>
...
<\/script>
`},{highlight:r(()=>[x]),default:r(()=>[p(h)]),_:1})])}}});export{_ as __pageData,I as default};
