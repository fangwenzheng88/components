...
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"}")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"</"),s("span",{style:{color:"#22863A"}},"script"),s("span",{style:{color:"#24292E"}},">")])])])],-1),W=JSON.parse('{"title":"edit-table-form","description":"","frontmatter":{},"headers":[],"relativePath":"components/edit-table-form.md","filePath":"components/edit-table-form.md","lastUpdated":1724054298000}'),M={name:"components/edit-table-form.md"},X=Object.assign(M,{setup(x){return(C,f)=>{const r=p("demo");return i(),v("div",null,[J,G,t(r,{customClass:"demoblock-custom",sourceCode:`<template>
...
<\/script>
`,options:'{"customClass":"demoblock-custom"}'},{highlight:a(()=>[K]),default:a(()=>[t(H)]),_:1})])}}});export{W as __pageData,X as default};
