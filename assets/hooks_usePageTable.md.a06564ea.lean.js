import{u as G}from"./chunks/index.d969091e.js";import{i as L}from"./chunks/dayjs.min.c0ea899f.js";import{u as W}from"./chunks/index.f794940e.js";import{h as B,a4 as K,d as X,C as t,o as d,c as b,H as o,w as n,l as _,L as j,b as x,a as l,t as w,k as s}from"./chunks/framework.dd579901.js";import"./chunks/cloneDeep.4d284b0e.js";const z=()=>({current:1,pageSize:10,total:0,showTotal:!0,showPageSize:!0});function H(F){const m=B(!1),u=B([]),c=W(F.columns),a=B(z());function g(r){return a.value.current=r,C()}function D(r){return a.value.current=1,a.value.pageSize=r,C()}L(F.pagination)&&(a.value={...z(),...F.pagination});function C(){return m.value=!0,F.fetch({pageNum:a.value.current,pageSize:a.value.pageSize,columnKeys:[...c.columnKeys.value]}).then(r=>{u.value=r.records,a.value.total=r.total}).finally(()=>{m.value=!1})}function y(){return C()}function p(){return a.value.current=1,C()}return F.immediate===!0&&p(),{tableData:u,loading:m,loadTableData:p,refreshData:y,pagination:a,tableInstance:c.tableInstance,originColumns:c.originColumns,columns:c.columns,columnKeys:c.columnKeys,resetColumns:c.resetColumns,changeColumnVisibleByDataIndex:c.changeColumnVisibleByDataIndex,updateColumnByDataIndex:c.updateColumnByDataIndex,replaceColumnByDataIndex:c.replaceColumnByDataIndex,tableConfig:K({loading:m,data:u,columns:c.columns,ref:c.ref,pagination:a,onPageChange:g,onPageSizeChange:D,onColumnResize(r,i){c.updateColumnByDataIndex(r,"width",i),c.updateColumnsWidth()}})}}const J={class:"vp-raw"},R=s("span",null,"查询",-1),Q=s("span",null,"重置",-1),Y=s("span",null,"新建",-1),Z=s("span",null,"批量导入",-1),ss=s("span",null,"下载",-1),ls=s("img",{alt:"avatar",src:"//p3-armor.byteimg.com/tos-cn-i-49unhts6dw/581b17753093199839f2e327e726b157.svg~tplv-49unhts6dw-image.image"},null,-1),os=s("img",{alt:"avatar",src:"//p3-armor.byteimg.com/tos-cn-i-49unhts6dw/77721e365eb2ab786c889682cbc721c1.svg~tplv-49unhts6dw-image.image"},null,-1),ns=s("img",{alt:"avatar",src:"//p3-armor.byteimg.com/tos-cn-i-49unhts6dw/ea8b09190046da0ea7e070d83c5d1731.svg~tplv-49unhts6dw-image.image"},null,-1),as={key:0,class:"circle"},es={key:1,class:"circle pass"},ts=X({__name:"usePageTable.md.demo.29f5ec9e",setup(F){function m(y){return new Promise(p=>{const r=new Array(y.pageSize).fill(1).map((i,E)=>({index:y.pageSize*(y.pageNum-1)+E+1,number:`number-${E}`,name:"XGMUNG",contentType:"img",count:6,status:"已下线",filterType:"人工筛选",createdTime:new Date}));setTimeout(()=>{p({records:r,total:1e3,pageNum:y.pageNum,pageSize:y.pageSize})})})}const{options:u}=G(()=>Promise.resolve([{label:"label-1",value:0},{label:"label-2",value:1}]),{immediate:!0}),c=()=>({number:"",name:"",contentType:"",filterType:"",createdTime:[],status:""}),a=B(c()),{loadTableData:g,tableConfig:D}=H({fetch(y){return console.log("查询条件：",a.value),m(y)},columns:[{title:"编号",dataIndex:"index",width:100},{title:"集合编号",dataIndex:"number",minWidth:200},{title:"集合名称",dataIndex:"name"},{title:"内容体裁",dataIndex:"contentType",slotName:"contentType"},{title:"筛选方式",dataIndex:"filterType",slotName:"filterType"},{title:"内容量",dataIndex:"count"},{title:"创建时间",dataIndex:"createdTime"},{title:"状态",dataIndex:"status",slotName:"status"},{title:"操作",dataIndex:"operations",slotName:"operations",width:120}],immediate:!0}),C=()=>{a.value=c()};return(y,p)=>{const r=t("a-input"),i=t("a-form-item"),E=t("a-col"),v=t("a-select"),I=t("a-range-picker"),A=t("a-row"),M=t("a-form"),k=t("a-divider"),P=t("icon-search"),f=t("a-button"),N=t("icon-refresh"),h=t("a-space"),S=t("icon-plus"),V=t("a-upload"),q=t("icon-download"),T=t("a-avatar"),U=t("a-link"),O=t("a-table"),$=t("a-card");return d(),b("div",J,[o($,{bordered:!1,title:"查询表格"},{default:n(()=>[o(A,null,{default:n(()=>[o(E,{flex:1},{default:n(()=>[o(M,{model:a.value,"label-col-props":{span:6},"wrapper-col-props":{span:18},"label-align":"left"},{default:n(()=>[o(A,{gutter:16},{default:n(()=>[o(E,{span:8},{default:n(()=>[o(i,{field:"number",label:"集合编号"},{default:n(()=>[o(r,{modelValue:a.value.number,"onUpdate:modelValue":p[0]||(p[0]=e=>a.value.number=e)},null,8,["modelValue"])]),_:1})]),_:1}),o(E,{span:8},{default:n(()=>[o(i,{field:"name",label:"集合名称"},{default:n(()=>[o(r,{modelValue:a.value.name,"onUpdate:modelValue":p[1]||(p[1]=e=>a.value.name=e)},null,8,["modelValue"])]),_:1})]),_:1}),o(E,{span:8},{default:n(()=>[o(i,{field:"contentType",label:"内容体裁"},{default:n(()=>[o(v,{modelValue:a.value.contentType,"onUpdate:modelValue":p[2]||(p[2]=e=>a.value.contentType=e)},null,8,["modelValue"])]),_:1})]),_:1}),o(E,{span:8},{default:n(()=>[o(i,{field:"filterType",label:"筛选方式"},{default:n(()=>[o(v,{modelValue:a.value.filterType,"onUpdate:modelValue":p[3]||(p[3]=e=>a.value.filterType=e)},null,8,["modelValue"])]),_:1})]),_:1}),o(E,{span:8},{default:n(()=>[o(i,{field:"createdTime",label:"创建时间"},{default:n(()=>[o(I,{modelValue:a.value.createdTime,"onUpdate:modelValue":p[4]||(p[4]=e=>a.value.createdTime=e),style:{width:"100%"}},null,8,["modelValue"])]),_:1})]),_:1}),o(E,{span:8},{default:n(()=>[o(i,{field:"status",label:"状态"},{default:n(()=>[o(v,{modelValue:a.value.status,"onUpdate:modelValue":p[5]||(p[5]=e=>a.value.status=e),options:_(u)},null,8,["modelValue","options"])]),_:1})]),_:1})]),_:1})]),_:1},8,["model"])]),_:1}),o(k,{style:{height:"84px"},direction:"vertical"}),o(E,{flex:"86px",style:{"text-align":"right"}},{default:n(()=>[o(h,{direction:"vertical",size:18},{default:n(()=>[o(f,{type:"primary",onClick:p[6]||(p[6]=e=>_(g)())},{icon:n(()=>[o(P)]),default:n(()=>[R]),_:1}),o(f,{onClick:C},{icon:n(()=>[o(N)]),default:n(()=>[Q]),_:1})]),_:1})]),_:1})]),_:1}),o(k,{style:{"margin-top":"0"}}),o(A,{style:{"margin-bottom":"16px"}},{default:n(()=>[o(E,{span:16},{default:n(()=>[o(h,null,{default:n(()=>[o(f,{type:"primary"},{icon:n(()=>[o(S)]),default:n(()=>[Y]),_:1}),o(V,{action:"/"},{"upload-button":n(()=>[o(f,null,{default:n(()=>[Z]),_:1})]),_:1})]),_:1})]),_:1}),o(E,{span:8,style:{"text-align":"right"}},{default:n(()=>[o(f,null,{icon:n(()=>[o(q)]),default:n(()=>[ss]),_:1})]),_:1})]),_:1}),o(O,j({bordered:!1,scrollbar:!1,"sticky-header":!0},_(D)),{contentType:n(({record:e})=>[o(h,null,{default:n(()=>[e.contentType==="img"?(d(),x(T,{key:0,size:16,shape:"square"},{default:n(()=>[ls]),_:1})):e.contentType==="horizontalVideo"?(d(),x(T,{key:1,size:16,shape:"square"},{default:n(()=>[os]),_:1})):(d(),x(T,{key:2,size:16,shape:"square"},{default:n(()=>[ns]),_:1})),l(" "+w(e.contentType),1)]),_:2},1024)]),filterType:n(({record:e})=>[l(w(e.filterType),1)]),status:n(({record:e})=>[e.status==="offline"?(d(),b("span",as)):(d(),b("span",es)),l(" "+w(e.status),1)]),operations:n(({record:e})=>[o(U,{type:"text",size:"small"},{default:n(()=>[l("编辑")]),_:1})]),_:1},16)]),_:1})])}}}),ps=s("h1",{id:"usetablepage",tabindex:"-1"},[l("useTablePage "),s("a",{class:"header-anchor",href:"#usetablepage","aria-label":'Permalink to "useTablePage"'},"​")],-1),cs=s("p",null,[s("code",null,"a-table"),l(" 前端页场景的工具函数，简化前端表格的配置")],-1),rs=s("p",null,[l("通过 "),s("code",null,"useColumns"),l(" 实现表格列minWidth，visible的功能")],-1),Es=s("div",{class:"language-vue vp-adaptive-theme"},[s("span",{class:"lang"},"vue"),s("pre",{"v-pre":"",class:"shiki github-dark vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"<"),s("span",{style:{color:"#85E89D"}},"template"),s("span",{style:{color:"#E1E4E8"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"}")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"</"),s("span",{style:{color:"#22863A"}},"script"),s("span",{style:{color:"#24292E"}},">")])])])],-1),Cs=JSON.parse('{"title":"useTablePage","description":"","frontmatter":{},"headers":[],"relativePath":"hooks/usePageTable.md","filePath":"hooks/usePageTable.md","lastUpdated":null}'),ys={name:"hooks/usePageTable.md"},fs=Object.assign(ys,{setup(F){return(m,u)=>{const c=t("demo");return d(),b("div",null,[ps,cs,rs,o(c,{customClass:"demoblock-custom",sourceCode:`<template>
  <div class="vp-raw">
...
<\/script>
`},{highlight:n(()=>[Es]),default:n(()=>[o(ts)]),_:1})])}}});export{Cs as __pageData,fs as default};
