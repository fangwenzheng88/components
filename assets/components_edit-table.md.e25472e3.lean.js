...
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"}")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"</"),s("span",{style:{color:"#22863A"}},"script"),s("span",{style:{color:"#24292E"}},">")])])])],-1),Q=JSON.parse('{"title":"edit-table","description":"","frontmatter":{},"headers":[],"relativePath":"components/edit-table.md","filePath":"components/edit-table.md","lastUpdated":1703748877000}'),K={name:"components/edit-table.md"},W=Object.assign(K,{setup(x){return(C,D)=>{const r=p("demo");return i(),v("div",null,[J,t(r,{customClass:"demoblock-custom",sourceCode:`<template>
...
<\/script>
`},{highlight:a(()=>[G]),default:a(()=>[t(H)]),_:1})])}}});export{Q as __pageData,W as default};
