...
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"})")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"</"),s("span",{style:{color:"#22863A"}},"script"),s("span",{style:{color:"#24292E"}},">")])])])],-1),_=JSON.parse('{"title":"useTable","description":"","frontmatter":{},"headers":[],"relativePath":"hooks/useTable.md","filePath":"hooks/useTable.md","lastUpdated":null}'),g={name:"hooks/useTable.md"},I=Object.assign(g,{setup(i){return(e,a)=>{const n=E("demo");return y(),b("div",null,[B,p(n,{customClass:"demoblock-custom",sourceCode:`<template>
