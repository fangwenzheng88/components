import{u as U}from"./chunks/index.39ff5eed.js";import{u as $}from"./chunks/usePageTable.9bdb070a.js";import"./chunks/dayjs.min.1edc150c.js";import{d as O,h as G,C as e,o as y,c as d,H as o,w as n,l as b,L,b as g,a as l,t as D,k as s}from"./chunks/framework.f6b614a8.js";import"./chunks/is.816509ab.js";import"./chunks/index.f8290869.js";import"./chunks/index.ee9bd0d1.js";const W={class:"vp-raw"},X=s("span",null,"查询",-1),j=s("span",null,"重置",-1),H=s("span",null,"新建",-1),J=s("span",null,"批量导入",-1),K=s("span",null,"下载",-1),Q=s("img",{alt:"avatar",src:"//p3-armor.byteimg.com/tos-cn-i-49unhts6dw/581b17753093199839f2e327e726b157.svg~tplv-49unhts6dw-image.image"},null,-1),R=s("img",{alt:"avatar",src:"//p3-armor.byteimg.com/tos-cn-i-49unhts6dw/77721e365eb2ab786c889682cbc721c1.svg~tplv-49unhts6dw-image.image"},null,-1),Y=s("img",{alt:"avatar",src:"//p3-armor.byteimg.com/tos-cn-i-49unhts6dw/ea8b09190046da0ea7e070d83c5d1731.svg~tplv-49unhts6dw-image.image"},null,-1),Z={key:0,class:"circle"},ss={key:1,class:"circle pass"},ls=O({__name:"usePageTable.md.demo.29f5ec9e",setup(_){function v(r){return new Promise(t=>{const m=new Array(r.pageSize).fill(1).map((E,c)=>({index:r.pageSize*(r.pageNum-1)+c+1,number:`number-${c}`,name:"XGMUNG",contentType:"img",count:6,status:"已下线",filterType:"人工筛选",createdTime:new Date}));setTimeout(()=>{t({records:m,total:1e3,pageNum:r.pageNum,pageSize:r.pageSize})})})}const{options:A}=U(()=>Promise.resolve([{label:"label-1",value:0},{label:"label-2",value:1}]),{immediate:!0}),F=()=>({number:"",name:"",contentType:"",filterType:"",createdTime:[],status:""}),p=G(F()),{loadTableData:h,tableConfig:w}=$({fetch(r){return console.log("查询条件：",p.value),v(r)},columns:[{title:"编号",dataIndex:"index",width:100},{title:"集合编号",dataIndex:"number",minWidth:200},{title:"集合名称",dataIndex:"name"},{title:"内容体裁",dataIndex:"contentType",slotName:"contentType"},{title:"筛选方式",dataIndex:"filterType",slotName:"filterType"},{title:"内容量",dataIndex:"count"},{title:"创建时间",dataIndex:"createdTime"},{title:"状态",dataIndex:"status",slotName:"status"}],operations(){return[{label:"详情",action:()=>{console.log("详情")}}]},immediate:!0}),x=()=>{p.value=F()};return(r,t)=>{const m=e("a-input"),E=e("a-form-item"),c=e("a-col"),u=e("a-select"),M=e("a-range-picker"),C=e("a-row"),k=e("a-form"),T=e("a-divider"),z=e("icon-search"),i=e("a-button"),P=e("icon-refresh"),f=e("a-space"),N=e("icon-plus"),I=e("a-upload"),S=e("icon-download"),B=e("a-avatar"),V=e("a-table"),q=e("a-card");return y(),d("div",W,[o(q,{bordered:!1,title:"查询表格"},{default:n(()=>[o(C,null,{default:n(()=>[o(c,{flex:1},{default:n(()=>[o(k,{model:p.value,"label-col-props":{span:6},"wrapper-col-props":{span:18},"label-align":"left"},{default:n(()=>[o(C,{gutter:16},{default:n(()=>[o(c,{span:8},{default:n(()=>[o(E,{field:"number",label:"集合编号"},{default:n(()=>[o(m,{modelValue:p.value.number,"onUpdate:modelValue":t[0]||(t[0]=a=>p.value.number=a)},null,8,["modelValue"])]),_:1})]),_:1}),o(c,{span:8},{default:n(()=>[o(E,{field:"name",label:"集合名称"},{default:n(()=>[o(m,{modelValue:p.value.name,"onUpdate:modelValue":t[1]||(t[1]=a=>p.value.name=a)},null,8,["modelValue"])]),_:1})]),_:1}),o(c,{span:8},{default:n(()=>[o(E,{field:"contentType",label:"内容体裁"},{default:n(()=>[o(u,{modelValue:p.value.contentType,"onUpdate:modelValue":t[2]||(t[2]=a=>p.value.contentType=a)},null,8,["modelValue"])]),_:1})]),_:1}),o(c,{span:8},{default:n(()=>[o(E,{field:"filterType",label:"筛选方式"},{default:n(()=>[o(u,{modelValue:p.value.filterType,"onUpdate:modelValue":t[3]||(t[3]=a=>p.value.filterType=a)},null,8,["modelValue"])]),_:1})]),_:1}),o(c,{span:8},{default:n(()=>[o(E,{field:"createdTime",label:"创建时间"},{default:n(()=>[o(M,{modelValue:p.value.createdTime,"onUpdate:modelValue":t[4]||(t[4]=a=>p.value.createdTime=a),style:{width:"100%"}},null,8,["modelValue"])]),_:1})]),_:1}),o(c,{span:8},{default:n(()=>[o(E,{field:"status",label:"状态"},{default:n(()=>[o(u,{modelValue:p.value.status,"onUpdate:modelValue":t[5]||(t[5]=a=>p.value.status=a),options:b(A)},null,8,["modelValue","options"])]),_:1})]),_:1})]),_:1})]),_:1},8,["model"])]),_:1}),o(T,{style:{height:"84px"},direction:"vertical"}),o(c,{flex:"86px",style:{"text-align":"right"}},{default:n(()=>[o(f,{direction:"vertical",size:18},{default:n(()=>[o(i,{type:"primary",onClick:t[6]||(t[6]=a=>b(h)())},{icon:n(()=>[o(z)]),default:n(()=>[X]),_:1}),o(i,{onClick:x},{icon:n(()=>[o(P)]),default:n(()=>[j]),_:1})]),_:1})]),_:1})]),_:1}),o(T,{style:{"margin-top":"0"}}),o(C,{style:{"margin-bottom":"16px"}},{default:n(()=>[o(c,{span:16},{default:n(()=>[o(f,null,{default:n(()=>[o(i,{type:"primary"},{icon:n(()=>[o(N)]),default:n(()=>[H]),_:1}),o(I,{action:"/"},{"upload-button":n(()=>[o(i,null,{default:n(()=>[J]),_:1})]),_:1})]),_:1})]),_:1}),o(c,{span:8,style:{"text-align":"right"}},{default:n(()=>[o(i,null,{icon:n(()=>[o(S)]),default:n(()=>[K]),_:1})]),_:1})]),_:1}),o(V,L({bordered:!1,scrollbar:!1,"sticky-header":!0},b(w)),{contentType:n(({record:a})=>[o(f,null,{default:n(()=>[a.contentType==="img"?(y(),g(B,{key:0,size:16,shape:"square"},{default:n(()=>[Q]),_:1})):a.contentType==="horizontalVideo"?(y(),g(B,{key:1,size:16,shape:"square"},{default:n(()=>[R]),_:1})):(y(),g(B,{key:2,size:16,shape:"square"},{default:n(()=>[Y]),_:1})),l(" "+D(a.contentType),1)]),_:2},1024)]),filterType:n(({record:a})=>[l(D(a.filterType),1)]),status:n(({record:a})=>[a.status==="offline"?(y(),d("span",Z)):(y(),d("span",ss)),l(" "+D(a.status),1)]),_:1},16)]),_:1})])}}}),os=s("h1",{id:"usetablepage",tabindex:"-1"},[l("useTablePage "),s("a",{class:"header-anchor",href:"#usetablepage","aria-label":'Permalink to "useTablePage"'},"​")],-1),ns=s("p",null,[s("code",null,"a-table"),l(" 前端页场景的工具函数，简化前端表格的配置")],-1),as=s("p",null,[l("通过 "),s("code",null,"useColumns"),l(" 实现表格列 minWidth，visible 的功能")],-1),es=s("div",{class:"language-vue vp-adaptive-theme"},[s("span",{class:"lang"},"vue"),s("pre",{"v-pre":"",class:"shiki github-dark vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"<"),s("span",{style:{color:"#85E89D"}},"template"),s("span",{style:{color:"#E1E4E8"}},">")]),l(`
