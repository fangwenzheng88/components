...
<\/script>
`,options:'{"customClass":"demoblock-custom"}'},{highlight:E(()=>[f]),default:E(()=>[p(g)]),_:1}),w,_,p(n,{customClass:"demoblock-custom",sourceCode:`<template>
  <a-table class="vp-raw" v-bind="tableConfig"></a-table>
</template>
...
<\/script>
`,options:'{"customClass":"demoblock-custom"}'},{highlight:E(()=>[I]),default:E(()=>[p(h)]),_:1})])}}});export{L as __pageData,M as default};
