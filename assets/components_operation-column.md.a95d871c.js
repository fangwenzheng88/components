import"./chunks/use-popup-manager.76a89a53.js";import{u as b}from"./chunks/usePageTable.1c650c0d.js";import{d as v,C as p,o as e,c as y,H as r,w as n,L as f,l as h,b as F,a as l,t as d,k as s}from"./chunks/framework.aaf613a4.js";import"./chunks/is.816509ab.js";import"./chunks/index.0182750a.js";import"./chunks/index.aff44372.js";const D={class:"vp-raw"},T=s("img",{alt:"avatar",src:"//p3-armor.byteimg.com/tos-cn-i-49unhts6dw/581b17753093199839f2e327e726b157.svg~tplv-49unhts6dw-image.image"},null,-1),A=s("img",{alt:"avatar",src:"//p3-armor.byteimg.com/tos-cn-i-49unhts6dw/77721e365eb2ab786c889682cbc721c1.svg~tplv-49unhts6dw-image.image"},null,-1),_=s("img",{alt:"avatar",src:"//p3-armor.byteimg.com/tos-cn-i-49unhts6dw/ea8b09190046da0ea7e070d83c5d1731.svg~tplv-49unhts6dw-image.image"},null,-1),x={key:0,class:"circle"},w={key:1,class:"circle pass"},z=v({__name:"operation-column.md.demo.4777a70c",setup(g){function m(o){return new Promise(t=>{const c=new Array(o.pageSize).fill(1).map((u,E)=>({index:o.pageSize*(o.pageNum-1)+E+1,number:`number-${E}`,name:"XGMUNG",contentType:"img",count:6,status:"已下线",filterType:"人工筛选",createdTime:new Date}));setTimeout(()=>{t({records:c,total:1e3,pageNum:o.pageNum,pageSize:o.pageSize})})})}const{loadTableData:C,tableConfig:i}=b({fetch(o){return console.log("pagination:",o),m(o)},columns:[{title:"编号",dataIndex:"index",width:0,ellipsis:!0},{title:"集合编号",dataIndex:"number",minWidth:200},{title:"集合名称",dataIndex:"name"},{title:"内容体裁",dataIndex:"contentType",slotName:"contentType"},{title:"筛选方式",dataIndex:"filterType",slotName:"filterType"},{title:"内容量",dataIndex:"count"},{title:"创建时间",dataIndex:"createdTime"},{title:"状态",dataIndex:"status",slotName:"status"}],operations(o){return o.index>20?[]:[{label:"详情",action:()=>{console.log("详情")}},{label:"编辑",action:t=>{t.loading=!0,setTimeout(()=>{t.loading=!1},2e3),console.log("编辑")}},{label:"删除",disabled:!0,action:()=>{console.log("删除")}},{label:"启动",action:()=>{console.log("启动")}},{label:"停止",action:()=>{console.log("停止")}}]},immediate:!0});return(o,t)=>{const c=p("a-avatar"),u=p("a-space"),E=p("a-table"),B=p("a-card");return e(),y("div",D,[r(B,{bordered:!1,title:"表格"},{default:n(()=>[r(E,f({"column-resizable":"",bordered:{headerCell:!0},scrollbar:!1,"sticky-header":!0},h(i)),{contentType:n(({record:a})=>[r(u,null,{default:n(()=>[a.contentType==="img"?(e(),F(c,{key:0,size:16,shape:"square"},{default:n(()=>[T]),_:1})):a.contentType==="horizontalVideo"?(e(),F(c,{key:1,size:16,shape:"square"},{default:n(()=>[A]),_:1})):(e(),F(c,{key:2,size:16,shape:"square"},{default:n(()=>[_]),_:1})),l(" "+d(a.contentType),1)]),_:2},1024)]),filterType:n(({record:a})=>[l(d(a.filterType),1)]),status:n(({record:a})=>[a.status==="offline"?(e(),y("span",x)):(e(),y("span",w)),l(" "+d(a.status),1)]),_:1},16)]),_:1})])}}}),N=s("h1",{id:"operation-column",tabindex:"-1"},[l("operation-column "),s("a",{class:"header-anchor",href:"#operation-column","aria-label":'Permalink to "operation-column"'},"​")],-1),I=s("p",null,"a-table 操作列单元格组件，配合 useTable/usePageTable 使用",-1),P=s("ul",null,[s("li",null,"operations 操作列数组")],-1),k=s("div",{class:"language-vue vp-adaptive-theme"},[s("span",{class:"lang"},"vue"),s("pre",{"v-pre":"",class:"shiki github-dark vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"<"),s("span",{style:{color:"#85E89D"}},"template"),s("span",{style:{color:"#E1E4E8"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"    <"),s("span",{style:{color:"#85E89D"}},"a-card"),s("span",{style:{color:"#E1E4E8"}}," "),s("span",{style:{color:"#B392F0"}},":bordered"),s("span",{style:{color:"#E1E4E8"}},"="),s("span",{style:{color:"#9ECBFF"}},'"false"'),s("span",{style:{color:"#E1E4E8"}}," "),s("span",{style:{color:"#B392F0"}},"title"),s("span",{style:{color:"#E1E4E8"}},"="),s("span",{style:{color:"#9ECBFF"}},'"表格"'),s("span",{style:{color:"#E1E4E8"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"      <"),s("span",{style:{color:"#85E89D"}},"a-table"),s("span",{style:{color:"#E1E4E8"}}," "),s("span",{style:{color:"#B392F0"}},"column-resizable"),s("span",{style:{color:"#E1E4E8"}}," "),s("span",{style:{color:"#B392F0"}},":bordered"),s("span",{style:{color:"#E1E4E8"}},"="),s("span",{style:{color:"#9ECBFF"}},'"{ headerCell: true }"'),s("span",{style:{color:"#E1E4E8"}}," "),s("span",{style:{color:"#B392F0"}},":scrollbar"),s("span",{style:{color:"#E1E4E8"}},"="),s("span",{style:{color:"#9ECBFF"}},'"false"'),s("span",{style:{color:"#E1E4E8"}}," "),s("span",{style:{color:"#B392F0"}},":sticky-header"),s("span",{style:{color:"#E1E4E8"}},"="),s("span",{style:{color:"#9ECBFF"}},'"true"'),s("span",{style:{color:"#E1E4E8"}}," "),s("span",{style:{color:"#B392F0"}},"v-bind"),s("span",{style:{color:"#E1E4E8"}},"="),s("span",{style:{color:"#9ECBFF"}},'"tableConfig"'),s("span",{style:{color:"#E1E4E8"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"      width: "),s("span",{style:{color:"#79B8FF"}},"0"),s("span",{style:{color:"#E1E4E8"}},",")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"      ellipsis: "),s("span",{style:{color:"#79B8FF"}},"true")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"    },")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"    {")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"    "),s("span",{style:{color:"#6A737D"}},"// 例子: 大于20条不展示操作列")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"    "),s("span",{style:{color:"#F97583"}},"if"),s("span",{style:{color:"#E1E4E8"}}," (record.index "),s("span",{style:{color:"#F97583"}},">"),s("span",{style:{color:"#E1E4E8"}}," "),s("span",{style:{color:"#79B8FF"}},"20"),s("span",{style:{color:"#E1E4E8"}},") {")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"      "),s("span",{style:{color:"#F97583"}},"return"),s("span",{style:{color:"#E1E4E8"}}," []")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"    }")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"    "),s("span",{style:{color:"#F97583"}},"return"),s("span",{style:{color:"#E1E4E8"}}," [")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"      {")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"      width: "),s("span",{style:{color:"#005CC5"}},"0"),s("span",{style:{color:"#24292E"}},",")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"      ellipsis: "),s("span",{style:{color:"#005CC5"}},"true")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"    },")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"    {")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"    "),s("span",{style:{color:"#6A737D"}},"// 例子: 大于20条不展示操作列")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"    "),s("span",{style:{color:"#D73A49"}},"if"),s("span",{style:{color:"#24292E"}}," (record.index "),s("span",{style:{color:"#D73A49"}},">"),s("span",{style:{color:"#24292E"}}," "),s("span",{style:{color:"#005CC5"}},"20"),s("span",{style:{color:"#24292E"}},") {")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"      "),s("span",{style:{color:"#D73A49"}},"return"),s("span",{style:{color:"#24292E"}}," []")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"    }")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"    "),s("span",{style:{color:"#D73A49"}},"return"),s("span",{style:{color:"#24292E"}}," [")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"      {")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"})")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"</"),s("span",{style:{color:"#22863A"}},"script"),s("span",{style:{color:"#24292E"}},">")])])])],-1),M=JSON.parse('{"title":"operation-column","description":"","frontmatter":{},"headers":[],"relativePath":"components/operation-column.md","filePath":"components/operation-column.md","lastUpdated":1715764023000}'),S={name:"components/operation-column.md"},W=Object.assign(S,{setup(g){return(m,C)=>{const i=p("demo");return e(),y("div",null,[N,I,P,r(i,{customClass:"demoblock-custom",sourceCode:`<template>
  <div class="vp-raw">
...
<\/script>
`,options:'{"customClass":"demoblock-custom"}'},{highlight:n(()=>[k]),default:n(()=>[r(z)]),_:1})])}}});export{M as __pageData,W as default};
