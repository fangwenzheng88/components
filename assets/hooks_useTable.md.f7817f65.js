import"./chunks/dayjs.min.1edc150c.js";import{u as F}from"./chunks/useTable.4c835a98.js";import{d,C as r,o as y,b as u,L as C,l as m,j as b,c as B,H as p,w as E,k as s,a as l}from"./chunks/framework.f6b614a8.js";import"./chunks/is.816509ab.js";import"./chunks/index.f8290869.js";import"./chunks/index.ee9bd0d1.js";const h=d({__name:"useTable.md.demo.4cb3a1a6",setup(i){function t(){return new Promise(o=>{const e=new Array(30).fill(1).map((c,n)=>({index:n+1,name:`name-${n}`,htbhnew:`NO-${n}`,qdrq:new Date,level:1}));setTimeout(()=>{o(e)})})}const{tableConfig:a}=F({fetch:t,columns:[{title:"编号",dataIndex:"index",width:120},{title:"事项主题",dataIndex:"name"},{title:"相关合同",dataIndex:"htbhnew"},{title:"到期日期",dataIndex:"qdrq"},{title:"优先级",dataIndex:"level"}],operations(){return[{label:"详情",action:()=>{console.log("详情")}}]},immediate:!0,pagination:!0});return(o,e)=>{const c=r("a-table");return y(),u(c,C({class:"vp-raw"},m(a)),null,16)}}}),x=d({__name:"useTable.md.demo.4cb3a1a4",setup(i){const{tableData:t,loading:a,tableConfig:o}=F({columns:[{title:"编号",dataIndex:"index",width:120},{title:"事项主题",dataIndex:"name"},{title:"相关合同",dataIndex:"htbhnew"},{title:"到期日期",dataIndex:"qdrq"},{title:"优先级",dataIndex:"level"}],operations(){return[{label:"详情",action:()=>{console.log("详情")}}]},pagination:!0});return b(()=>{const e=new Array(30).fill(1).map((c,n)=>({index:n+1,name:`name-${n}`,htbhnew:`NO-${n}`,qdrq:new Date,level:1}));a.value=!0,setTimeout(()=>{a.value=!1,t.value=e},1e3)}),(e,c)=>{const n=r("a-table");return y(),u(n,C({class:"vp-raw"},m(o)),null,16)}}}),g=s("h1",{id:"usetable",tabindex:"-1"},[l("useTable "),s("a",{class:"header-anchor",href:"#usetable","aria-label":'Permalink to "useTable"'},"​")],-1),v=s("p",null,[s("code",null,"a-table"),l(" 前端分页、不分页场景的工具函数，简化前端表格的配置")],-1),D=s("p",null,[l("通过 "),s("code",null,"useColumns"),l(" 实现表格列 minWidth，visible 的功能")],-1),A=s("h2",{id:"示例一",tabindex:"-1"},[l("示例一 "),s("a",{class:"header-anchor",href:"#示例一","aria-label":'Permalink to "示例一"'},"​")],-1),f=s("div",{class:"language-vue vp-adaptive-theme"},[s("span",{class:"lang"},"vue"),s("pre",{"v-pre":"",class:"shiki github-dark vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"<"),s("span",{style:{color:"#85E89D"}},"template"),s("span",{style:{color:"#E1E4E8"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"})")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"</"),s("span",{style:{color:"#22863A"}},"script"),s("span",{style:{color:"#24292E"}},">")])])])],-1),L=JSON.parse('{"title":"useTable","description":"","frontmatter":{},"headers":[],"relativePath":"hooks/useTable.md","filePath":"hooks/useTable.md","lastUpdated":null}'),q={name:"hooks/useTable.md"},M=Object.assign(q,{setup(i){return(t,a)=>{const o=r("demo");return y(),B("div",null,[g,v,D,A,p(o,{customClass:"demoblock-custom",sourceCode:`<template>
...
<\/script>
`},{highlight:E(()=>[f]),default:E(()=>[p(h)]),_:1}),w,_,p(o,{customClass:"demoblock-custom",sourceCode:`<template>
  <a-table class="vp-raw" v-bind="tableConfig"></a-table>
</template>
...
<\/script>
`},{highlight:E(()=>[I]),default:E(()=>[p(x)]),_:1})])}}});export{L as __pageData,M as default};
